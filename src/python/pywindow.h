...
#ifndef CRICAUDIO_PYTHON_PYWINDOW_H
#define CRICAUDIO_PYTHON_PYWINDOW_H
...
public:
  ...
  static void dealloc(PyObject* self) {
    delete reinterpret_cast<PyWindow*>(self)->base;
  ...
  static PyObject* make_new_from_data(PyTypeObject* type, PyObject* args,
                                      PyObject* kwds, Window::Window* data) {
    PyWindow* self = (PyWindow*)make_new(type, args, kwds);
    self->base = data;
...
#endif // CRICAUDIO_PYTHON_PYWINDOW_H
