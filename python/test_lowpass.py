...
if plot:
    plot_freqz(rc_b, rc_a, title = 'LowPass Chebyshev I order %d' % order)
...
if plot:
    plot_freqz(rc_b, rc_a, title = 'LowPass Chebyshev II order %d' % order)
...
if plot:
    plot_freqz(rc_b, rc_a, title = 'LowPass Butterworth order %d' % order)
...
if plot:
    plot_freqz(rc_b, rc_a, title = 'LowPass Bessel order %d' % order)
