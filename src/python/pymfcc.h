...
#ifndef CRICAUDIO_PYTHON_PYMFCC_H
#define CRICAUDIO_PYTHON_PYMFCC_H
...
public:
  ...
  static void dealloc(PyObject* self) {
    delete reinterpret_cast<PyMFCC*>(self)->base;
  ...
  static PyObject* make_new_from_data(PyTypeObject* type, PyObject* args,
                                      PyObject* kwds, MFCC::MFCC* data) {
    PyMFCC* self = (PyMFCC*)make_new(type, args, kwds);
    self->base = data;
...
#endif // CRICAUDIO_PYTHON_PYMFCC_H
